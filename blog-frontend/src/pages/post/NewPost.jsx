    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#f7f7f7] to-white flex items-center justify-center px-4 py-10">
            <div className="w-full max-w-6xl bg-white/30 backdrop-blur-xl border border-white/30 shadow-2xl rounded-3xl p-8 md:p-10">
                ...
                <div className="relative flex flex-col md:flex-row md:items-center md:justify-center mb-10 px-0 gap-4 md:gap-0">
                    <div className="md:absolute md:left-0 md:top-1/2 md:-translate-y-1/4">
                        <button
                            className="flex items-center gap-2 px-4 py-2 text-sm bg-black text-white rounded-full hover:bg-gray-900 transition"
                            onClick={() => navigate(-1)}
                        >
                            <span>Back</span>
                        </button>
                    </div>
                    <h1 className="text-2xl md:text-4xl font-serif font-bold text-gray-800 text-center w-full">
                        📝 New Blog Post
                    </h1>
                </div>
